---
description: Update metadata on an existing task without moving it. Usage: /office:task-update <task-id> [priority:HIGH|MEDIUM|LOW] [assignee:name] [estimate:4h] [labels:bug,auth] [deps:T001,T002]
---

$ARGUMENTS format: `<task-id> [priority:HIGH|MEDIUM|LOW] [assignee:name] [estimate:4h] [labels:tag1,tag2] [deps:id,...]`
...
- `/office:task-update fix-upload assignee:Security labels:security` — reassign and tag
