...
Check whether the framework is already installed in this project by looking for `.claude/commands/office/.version` and `.ai-office/`.
...
Then come back and run /office:ai-office to continue setup.
```
